# A Prayer for Blue Delaney — Reader's Log
**by Simon Köper, Class 9/1, Gymnasium Berthold Brecht**
...
- [Cover](Cover.png)
- [AI Usage](AI-Usage.md) — which AI tools were used and how
- [Claude Code Usage](claude-code-usage.md) — what Claude Code did and which prompts were used
- [How to open .md files](How-to-open-MD.md)
